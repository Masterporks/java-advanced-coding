...
public class Main {
    public static void main(String[] args) {
        ...
        javaDeveloper.setFirstName("Joosep");
        javaDeveloper.setAge(44);
        javaDeveloper.setHasExperience(true);
        javaDeveloper.setLastName("Konn");
        javaDeveloper.setSalary(234);



        System.out.println(javaDeveloper);
        System.out.println(javaDeveloper.isWorking());
